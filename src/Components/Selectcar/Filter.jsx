...
function Filter() {
  ...
  <label for="vehicle1"><span> Hackback</span> </label><br/>
  <input type="checkbox" id="vehicle2" name="vehicle2" value="Car"/>
  <label for="vehicle2"> Sedan</label><br/>
  <input type="checkbox" id="vehicle3" name="vehicle3" value="Boat"/>
  <label for="vehicle3"> Suv</label><br/><br/>
...
<input type="checkbox" id="manual" name="manual" value="Bike"/>
  <label for="manual"><span> Manual</span> </label><br/>
  <input type="checkbox" id="auto" name="auto" value="Car"/>
  <label for="auto"> Automatic</label><br/>  <br/>
        </div>
    </div>
  )
}
